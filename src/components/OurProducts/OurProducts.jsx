                ...
                <div className='flex flex-col md:flex-row gap-4 md:mt-16 justify-center  items-center'>
                    ...
                    <div className="flex gap-1 md:gap-14 justify-center mx-3 -mt-3">
                        <select onChange={(e) => {
                            ...
                            <option>IMPORTED MEXICAN FOODS</option>
                            <option>REF-JUICES-REFRIGERATED</option>
                            <option>WATER</option>
                            <option>COFFEE</option>
                            <option>FROZEN DINNERS/ENTREES</option>
                            <option>FROZEN POT PIES</option>
                            <option>FOILS/WRAPS/MTCH/TTHPCKS</option>
