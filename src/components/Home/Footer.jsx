...
const Footer = () => {
    return (
        <div className='max-w-[350px] md:max-w-[750px] lg:max-w-[1550px] mx-auto  md:mb-16'>
            <footer className="flex flex-col md:flex-row  justify-between text-base-content  py-10">
                ...
                <div className='flex flex-row md:flex-row gap-5 lg:gap-60 justify-between mt-5 md:mt-0'>
                    <div className='space-y-2 lg:space-y-4 flex flex-col inter-font'>
                        ...
                        <a className="link link-hover text-[#555555] lg:text-[24px] font-medium">About us</a>
                        <a className="link link-hover  text-[#555555] lg:text-[24px] font-medium">Our Founders</a>
                        <a className="link link-hover  text-[#555555] lg:text-[24px] font-medium">Blogs</a>
                        <a className="link link-hover  text-[#555555] lg:text-[24px] font-medium">FAQ</a>
                    </div>
                    <nav className='space-y-2 lg:space-y-4 flex flex-col inter-font'>
                    ...
                    <nav className=' space-y-2 lg:space-y-4 flex flex-col inter-font'>
                        ...
                        <a className="link link-hover text-[#555555] lg:text-[24px] font-medium">example@email.com</a>
                        <a className="link link-hover  text-[#555555] lg:text-[24px] font-medium">+1 730 062 423</a>
