...
const Footer = () => {
    return (
        <div className="mt-2 md:mt-8 footer-image" style={{
            ...
            <div className="flex justify-around items-center pt-2 md:pt-4">
                ...
                <div>
                    ...
                    <img className="w-12 md:w-20" src={image4} alt="" />
                ...
                <div>
                    ...
                    <p className=" text-white test-sm md:text-base font-normal">
                        Privacy policy
                    </p>
            ...
            <div className="footer px-3 md:px-10 pt-5 md:pt-8 pb-4 md:pb-12  text-white test-sm md:text-base font-normal flex justify-center  ">
