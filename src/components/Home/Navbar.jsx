...
const Navbar = () => {
  ...
  const navLinks = <>
    ...
    <li><NavLink to="/ourBrands" className=" text-black text-lg font-medium  hover:text-[#F26B24]" >Brands</NavLink></li>
    <li><NavLink to="/ourProducts" className=" text-black text-lg font-medium  hover:text-[#F26B24]" >Products</NavLink></li>
  ...
  return (
    ...
    >
      ...
      <div className='z-[100] max-w-[380px] md:max-w-[750px]  lg:max-w-[1550px] lg:px-10  mx-auto '>
          ...
          <div className="mr-5 md:w-1/6  md:mr-0 flex justify-end items-center gap-3 md:gap-8">
            ...
            <div className="flex items-center gap-4">
              {!isSearchOpen ? (
                ...
                >
                  <FaSearch className='text-black text-[20px] md:text-[24px]' />
                </button>
              ) : (
                <div className="relative flex items-center">
                  <input
                    ...
                    className="w-40 md:w-64 px-4 py-1 md:py-2 rounded-lg border border-orange-300 focus:outline-none focus:ring-1 focus:ring-[#F26B24]"
                    autoFocus
                  />
                  <button
                    onClick={() => {
                  ...
                  >
                    <ImCancelCircle className="text-[20px] md:text-[24px] text-gray-600" />
                  </button>
                    ...
                    <div className="absolute top-full mt-2 w-full bg-white rounded-lg shadow-lg border border-gray-200 max-h-96 overflow-y-auto">
                      {filteredProducts.length > 0 ? (
                        filteredProducts.map((product) => (
                          <div
                            key={product.id}
                            className="p-2 md:p-4 hover:bg-gray-50 cursor-pointer border-b last:border-b-0  flex justify-center items-center"
                          >
                            <div className='flex  justify-between items-center gap-2 md:gap-4'>
                              <div className="w-12 md:w-16 h-10 md:h-20 ">
                                <img className='w-full h-full' src={product.image} alt="" />
                              </div>
                              <div className="font-medium text-[10px] md:text-sm flex-1 text-gray-800">{product.productTitle}</div>
                            </div>
