...
const Testimonial = () => {
    return (
        <div>
            <div className='max-w-[350px] md:max-w-[850px] lg:max-w-[1550px] mx-auto flex justify-center items-center mt-20 md:mt-10 md:mb-20 '>

                <div className="flex w-full flex-col lg:flex-row gap-16 lg:gap-20">
                    <div className='md:w-3/6 flex md:ml-24'>
                        <div className='flex justify-center items-center' >
                            <img className='w-[300px] md:w-[514px] ml-6 md:ml-0' src={testimonialImg1} alt="" />
                        </div>
                        <img className='-ml-[50px] md:-ml-[170px] mt-[50px] md:mt-[42px] absolute md:w-[720px]' src={testimonialImg2} alt="" />
